...
public class ConnectionStatusSnapshotDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, groupId, name, sourceId, sourceName, destinationId, destinationName, flowFilesIn, bytesIn, input, flowFilesOut, bytesOut, output, flowFilesQueued, bytesQueued, queued, queuedSize, queuedCount);
  }
