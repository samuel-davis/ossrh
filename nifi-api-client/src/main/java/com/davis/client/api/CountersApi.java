...
import com.davis.client.model.CountersEntity;
import com.davis.client.model.CounterEntity;
...
public class CountersApi {
    ...
    private com.squareup.okhttp.Call getCountersCall(Boolean nodewise, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws
            ApiException {
    ...
    public ApiResponse<CountersEntity> getCountersWithHttpInfo(Boolean nodewise, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = getCountersCall(nodewise, clusterNodeId, null, null);
    ...
    public ApiResponse<CounterEntity> updateCounterWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = updateCounterCall(id, null, null);
