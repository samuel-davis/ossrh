...
import com.davis.client.model.ProvenanceOptionsEntity;
...
public class ProvenanceApi {
    ...
    private com.squareup.okhttp.Call deleteLineageCall(String id, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws
            ApiException {
        ...
        String localVarPath = "/provenance/lineage/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<LineageEntity> deleteLineageWithHttpInfo(String id, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = deleteLineageCall(id, clusterNodeId, null, null);
    ...
    private com.squareup.okhttp.Call deleteProvenanceCall(String id, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/provenance/{id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    public ApiResponse<ProvenanceEntity> deleteProvenanceWithHttpInfo(String id, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = deleteProvenanceCall(id, clusterNodeId, null, null);
    ...
    private com.squareup.okhttp.Call getLineageCall(String id, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<LineageEntity> getLineageWithHttpInfo(String id, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = getLineageCall(id, clusterNodeId, null, null);
        Type localVarReturnType = new TypeToken<LineageEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call getProvenanceCall(String id, String clusterNodeId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ProvenanceEntity getProvenance(String id, String clusterNodeId) throws ApiException {
        ApiResponse<ProvenanceEntity> resp = getProvenanceWithHttpInfo(id, clusterNodeId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ProvenanceEntity> getProvenanceWithHttpInfo(String id, String clusterNodeId) throws ApiException {
        com.squareup.okhttp.Call call = getProvenanceCall(id, clusterNodeId, null, null);
        Type localVarReturnType = new TypeToken<ProvenanceEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call getSearchOptionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/provenance/search-options".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<ProvenanceOptionsEntity> getSearchOptionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getSearchOptionsCall(null, null);
    ...
    private com.squareup.okhttp.Call submitLineageRequestCall(LineageEntity body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/provenance/lineage".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<LineageEntity> submitLineageRequestWithHttpInfo(LineageEntity body) throws ApiException {
        com.squareup.okhttp.Call call = submitLineageRequestCall(body, null, null);
        Type localVarReturnType = new TypeToken<LineageEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call submitProvenanceRequestCall(ProvenanceEntity body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        ...
        // create path and map variables
        String localVarPath = "/provenance".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<ProvenanceEntity> submitProvenanceRequestWithHttpInfo(ProvenanceEntity body) throws ApiException {
        com.squareup.okhttp.Call call = submitProvenanceRequestCall(body, null, null);
        Type localVarReturnType = new TypeToken<ProvenanceEntity>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
