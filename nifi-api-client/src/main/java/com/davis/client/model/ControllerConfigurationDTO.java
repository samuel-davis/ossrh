...
public class ControllerConfigurationDTO {
  ...
  public ControllerConfigurationDTO maxTimerDrivenThreadCount(Integer maxTimerDrivenThreadCount) {
   ...
   /**
   * The maimum number of timer driven threads the NiFi has available.
   * @return maxTimerDrivenThreadCount
  **/
  @ApiModelProperty(example = "null", value = "The maimum number of timer driven threads the NiFi has available.")
  ...
  public ControllerConfigurationDTO maxEventDrivenThreadCount(Integer maxEventDrivenThreadCount) {
   ...
   /**
   * The maximum number of event driven threads the NiFi has avaiable.
   * @return maxEventDrivenThreadCount
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of event driven threads the NiFi has avaiable.")
